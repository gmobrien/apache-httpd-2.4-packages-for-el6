...
Patch100: apr-1.5.1-httpd24-soname.patch
...
Requires:  %{?scl:%scl_prefix}apr = %{version}-%{release}, pkgconfig
...
* Tue Sep 17 2013 Jan Kaluza <jorton@redhat.com> - 1.4.8-2
...
* Fri Apr 19 2013 Jan Kaluza <jkaluza@redhat.com> - 1.4.6-2
